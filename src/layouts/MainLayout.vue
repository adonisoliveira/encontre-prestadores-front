  ...
  <q-layout view="lHh Lpr lFf">
      ...
      <q-toolbar>
        ...
        <q-toolbar-title class="text-white">
          ...
          <q-input
            ...
            dense
            standout
            placeholder="Pesquise profissionais aqui"
            input-class="text-right"
            class="q-ml-md full-width"
            @click="abrirPesquisar(true)"
          >
      ...
      <q-scroll-area style="width: 100%; height: 100%;">
        ...
        <q-list no-border padding class="rounded-borders text-grey-9">
          ...
          <q-item
            ...
            v-ripple
            active-class="my-menu-link"
            :active="link === 'buscar prestadores'"
            @click="redirecionar('buscar prestadores', '/categoria/principais')"
          >
            <q-item-section avatar>
          ...
          <q-item
            ...
            v-ripple
            active-class="my-menu-link"
            :active="link === 'minhas informacoes'"
            @click="redirecionar('minhas informacoes', '/pessoa/alterar')"
            v-if="!!usuario?._id"
          >
            <q-item-section avatar>
          ...
          <q-item
            ...
            clickable
            v-ripple
            @click="redirecionar('relatar problema', '/problema/relatar')"
          >
            <q-item-section avatar>
              <q-icon name="mdi-bug" />
            </q-item-section>
    ...
    <q-dialog v-model="pedePushNotification" persistent>
        <q-card style="width: 90vw">
            ...
            <q-card-section class="row items-center">
                <span class="text-subtitle1" style="padding-left: 15px">{{usuario.nome}} para que você seja informado sobre novos serviços ou sobre a situação dos serviços que solicitou, é necessário habilitar as notificações, assim você saberá em tempo real o que está acontecendo.</span>
            </q-card-section>
