<template>
  <q-layout view="lHh Lpr lFf">
    <q-page-container>
      <q-page>
        <q-footer>
          <q-btn label="Salvar" flat text-color="white" class="full-width bg-primary" size="18px" no-caps
            @click="salvar()" />
        </q-footer>
        ...
        <div class="row justify-center">
          <div style="width: 800px; max-width: 100vw;">
            <div class="row q-gutter-sm bg-primary text-white"
              ...
              <div>
                <q-btn label="Trocar Senha" flat text-color="white" class=" bg-primary" icon="mdi-textbox-password"
                  dense no-caps @click="isTrocarSenha = !isTrocarSenha" />
              </div>
            </div>
            ...
            <q-card elevation class="bg-white no-shadow" Style="border-radius: 3px; padding: 0px;">
              <q-card-section style="padding-top: 8px">
                <div class="row q-gutter-sm" style="margin: 0px">
                  <q-input v-model="usuario" label="Usuário" placeholder="Usuário utilizado para login"
                    :input-style="{ fontSize: '16px' }" class="full-width" disable outlined />

                  <q-input v-model="nome" ref="nome" label="Nome completo" placeholder="Informe seu nome completo"
                    :input-style="{ fontSize: '16px' }" class="full-width" outlined />
                  ...
                  <q-input v-model="descricao" ref="descricao" label="Descrição do negócio"
                    ...
                    class="full-width" outlined :input-style="{ fontSize: '16px' }" v-if="prestador_de_servicos" />

                  <q-toggle v-model="prestador_de_servicos" label="Sou um prestador de serviços"
                    checked-icon="mdi-check" color="primary" icon-color="white" size="80px" left-label
                    @click="exibe_Categoria()" v-if="categorias !== undefined && categorias.length > 0" />
                </div>

                <q-tabs v-model="tab" dense class="text-grey" active-color="primary" indicator-color="primary"
                  align="justify" narrow-indicator style="padding-top: 10px">
                ...
                <q-tab-panels v-model="tab" animated style="width: 100vw; margin-left:-17px">
                  <q-tab-panel name="endereco">
                    <div class="row q-gutter-sm" style="margin: 0px">
                      <q-input v-model="cep" ref="cep" label="CEP" type="number" class="full-width" @keyup="buscaCep()"
                        outlined />

                      <q-input v-model="logradouro" ref="logradouro" label="Logradouro" class="full-width" outlined />

                      <q-input v-model="numero" ref="numero" label="Número" class="full-width" outlined />

                      <q-input v-model="complemento" label="Complemento" class="full-width" outlined />

                      <q-input v-model="bairro" ref="bairro" label="Bairro" class="full-width" outlined />

                      <q-input v-model="cidadeUf" label="Cidade" class="full-width" outlined disable />
                    </div>
                  </q-tab-panel>
                  ...
                  <q-tab-panel name="contatos">
                      ...
                      <template v-for="contato in contatos" :key="contato._id">
                        <q-item class="list-item">
                          <q-item-section avatar style="padding-right: 10px !important; min-width: 0px !important;">
                            <q-btn flat dense icon="mdi-delete-forever" text-color="grey-10"
                    ...
                    <q-page-sticky position="bottom-right" :offset="[18, 18]">
                      <q-btn fab icon="mdi-plus" color="primary" @click="popUpEditarContato('i', null)" />
                    </q-page-sticky>
                  </q-tab-panel>
                  ...
                  <q-tab-panel name="categorias">
                    ...
                    <q-page-sticky position="bottom-right" :offset="[18, 18]">
                      <q-btn fab icon="mdi-plus" color="primary" @click="abrirListaCategorias()" />
                    </q-page-sticky>
                  </q-tab-panel>
          ...
          <q-card-section class="row items-center">
            <div class="row q-gutter-sm" style="margin: 0px">
              ...
              <q-input v-model="confirmaSenha" ref="confirmaSenha" label="Confirmar senha"
                ...
                <template v-slot:append>
                  <q-icon :name="isPwd2 ? 'mdi-eye-off' : 'mdi-eye'" class="cursor-pointer" @click="isPwd2 = !isPwd2" />
                </template>
              </q-input>
            </div>
          </q-card-section>
        ...
        <q-card style="width: 90vw">
          ...
          <q-card-section class="row items-center">
            <q-input v-model="telefoneContato" ref="telefoneContato" label="Telefone" placeholder="(99) 99999-9999"
              class="full-width" outlined @keyup="formataTelefone()" />

            <q-toggle v-model="whatsapp" label="Esse telefone tem Whatsapp?" checked-icon="mdi-whatsapp" color="primary"
              icon-color="white" size="75px" left-label />
          </q-card-section>
