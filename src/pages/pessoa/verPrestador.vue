<template>
  <q-layout view="lHh Lpr lFf">
    <q-page-container>
      <q-page>
        <q-footer>
          <q-btn :label="labelBtnAcao" flat text-color="white" :class="classBtnAcao" size="20px" no-caps
            @click="confirmar()" />
        </q-footer>
            ...
            <div class="row q-gutter-sm bg-primary text-white"
              ...
              <div class="row" style="padding-top: 10px;">
                ...
                <div class="col-12">
                  ...
                  <span class="text-subtitle2" style="padding-left: 5px">{{ nota }} baseado em {{ qtdAvaliacoes }}
                    avaliações</span>
                </div>
              </div>
            </div>
                  ...
                  <div class="row full-width">
                    ...
                    <div class="col-5">
                      <div class="row full-width justify-center" style="padding-top: 15px">
                        <q-btn label="Quero Avaliar" icon-right="mdi-chevron-right" dense flat color="primary"
                      ...
                      <template v-for="avaliacao in avaliacoes" :key="avaliacao._id">
                        <q-item class="list-item">
                          <q-item-section style="">
                            <q-item-label
                              class="text-subtitle1 text-weight-medium text-primary">{{ avaliacao.nome }}</q-item-label>
                            <q-item-label class="text-subtitle1 text-weight-medium text-primary">
                              <div class="q-gutter-y-md column">
                                <q-rating v-model="avaliacao.nota" :max="5" size="xs" color="yellow-8"
                                  icon="mdi-star-outline" icon-selected="mdi-star" icon-half="mdi-star-half" readonly />
                              </div>
                            </q-item-label>
                            <q-item-label class="text-grey-8"
                              style="font-size: 14px">{{ avaliacao.descricao }}</q-item-label>
                          </q-item-section>
                        </q-item>
                      </template>
                    </q-list>
        ...
        <q-card style="width: 90vw">
          ...
          <q-card-section class="row items-center">
            <div class="row">
              ...
              <span class="text-subtitle2 text-weight-medium text-grey-6" style="margin-top: -10px">Escolha de 1 a 5
                estrelas</span>
            </div>

            <div class="row">
              <q-rating v-model="notaAvaliacao" :max="5" size="lg" color="yellow-8" icon="mdi-star-outline"
                icon-selected="mdi-star" icon-half="mdi-star-half" />
            </div>
            ...
            <q-input v-model="descricaoAvaliacao" ref="descricaoAvaliacao" type="textarea" class="full-width" autogrow
              :input-style="{ fontSize: '16px' }" outlined @keyup.enter="enviarAvaliacao()" />
          </q-card-section>
