                  ...
                  <q-card-section style="padding-top: 8px">
                      <div class="row">
                          <div class="row full-width" style="padding-bottom: 10px; text-align: justify;">
                              <span class="text-body2">Seu relato é muito importante para nós, por favor informe o máximo de detalhes sobre o problema, analisaremos seu relato e vamos corrigir o problema o mais rápido possível para que a plataforma continue te ajudando. </span>
                          </div>
                      </div>
                      ...
                      <div class="row full-width" style="padding-top: 5px">
                          <q-select
                              ...
                              lazy-rules
                              :rules="tipoDispositivoRequired"
                              class="text-grey-9 full-width"
                              outlined
                          >
                      ...
                      <div class="row full-width" style="padding-top: 5px">
                          <q-select
                              ...
                              :options="sistemaOperacionalOptions"
                              lazy-rules
                              :rules="sistemaOperacionalRequired"
                              class="text-grey-9 full-width"
                              outlined
                          >
                              <template v-slot:option="scope">
                      ...
                      <div class="row full-width" style="padding-top: 5px">
                          <q-select
                              ...
                              ref="tipoRede"
                              label="Tipo de rede"
                              :options="tipoRedeOptions"
                              lazy-rules
                              :rules="tipoRedeRequired"
                              class="text-grey-9 full-width"
                              outlined
                          >
                              <template v-slot:option="scope">
                      ...
                      <div class="row full-width" style="padding-top: 5px">
                          <q-input
                              ...
                              error-message="Descreva o problema com o mínimo de 20 caracteres."
                              class="full-width"
                              outlined
