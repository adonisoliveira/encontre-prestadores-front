          ...
          <div style="width: 800px; max-width: 100vw;">
            <q-card class="no-shadow">
              <div class="row q-gutter-sm bg-primary text-white"
                style="padding-left: 12px; padding-right: 10px; padding-top: 9px; padding-bottom: 2px;">
                <div class="col-1">
                  <q-btn icon="mdi-arrow-left" dense flat color="white" @click="voltar()" />
                </div>
                <div class="col-10">
                  <q-input v-model="pesquisar" ref="pesquisar" dark dense placeholder="Qual profissional você procura?"
                    input-class="text-center" class="q-ml-md full-width" :input-style="{ fontSize: '18px' }"
                    @input="filtrar()">
                  ...
                  <template v-for="categoria in listaCategoria" :key="categoria._id">
                    ...
                    <q-list class="full-width">
                      <template v-for="subcategoria in categoria.subCategorias" :key="subcategoria._id">
                        <q-item clickable v-ripple class="list-item" style="padding-left: 16px; padding-right: 16px;"
