  ...
  <q-layout view="lHh Lpr lFf">
          ...
          <q-page>
              ...
              <q-card elevation class="bg-white no-shadow" Style="border-radius: 3px; padding: 0px;">
                  <q-card-section style="padding-top: 8px">
                      ...
                      <q-input
                          v-model="logradouroEndereco"
                          ref="logradouroEndereco"
                          label="Rua"
                          class="full-width"
                          :input-style="{ fontSize: '16px' }"
                      />
      ...
      <q-dialog v-model="popUpListarEnderecoAberta" persistent>
          <q-card style="width: 90vw">
              ...
              <q-card-section style="max-height: 50vh" class="scroll">
                  <q-list separator>
                      <template v-for="(endereco, index) in listaEnderecos">
                          <q-item
                              class="list-item"
                          ...
                          >
                              ...
                              <q-item-section @click="informarEndereco(endereco)">
                                  ...
                                  <q-item-label class="text-subtitle1" v-if="endereco.complemento != undefined && endereco.complemento != null && endereco.complemento != ''">
              ...
              <q-card-actions align="right">
                  <q-btn flat label="Fechar" color="black" @click="popUpListarEnderecoAberta = !popUpListarEnderecoAberta" />
              </q-card-actions>
          </q-card>
      </q-dialog>
      ...
      <q-dialog v-model="popUpListarContatoAberta" persistent>
          <q-card style="width: 90vw">
              ...
              <q-card-section style="max-height: 50vh" class="scroll">
                  <q-list separator>
                      <template v-for="(contato, index) in listaContatos">
                          <q-item
                              class="list-item"
                              style="padding-top: 15px; padding-bottom: 15px"
                          >
          ...
          salvar () {
              ...
              if(salvar){
                  if(this.descricao !== undefined && this.descricao !== null && this.descricao !== ''){
                      ...
                      /*
                      if(this.inicioTrabalho !== undefined && this.inicioTrabalho !== null && this.inicioTrabalho != '' ){

                      }else{
                          salvar = false
                          this.$refs.inicioTrabalho.focus()
                          this.$q.notify({
                              icon: 'close',
                              color: 'negative',
                              message: `Informe a data aproximada para o início do serviço.`,
                              position: 'top'
                          })
                      }
                      */
