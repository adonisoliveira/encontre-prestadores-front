  ...
  <q-layout view="lHh Lpr lFf">
                          ...
                          <q-card-section>
                              ...
                              <div v-if="isContratante === true" style="padding-bottom: 25px;">
                                  <div class="row items-end" style="margin-top: -10px">
                                      <!-- <div class="col-2">
                                          <q-icon name="mdi-account-group" color="primary" size="28px" />
                                      </div> -->
                                      <div class="col-12">
                                              ...
                                              >
                                                  <q-item-section>
                                                      <q-item-label class="text-subtitle1 text-weight-medium">
                                                          <q-icon color="primary" name="mdi-check-bold" size="20px" v-if="prestador.contratado === true"/>
                                                          {{prestador.nome}}
                                                      </q-item-label>
                                                      <q-item-label class="text-body1 text-grey-7" lines="2">{{prestador.descricao}}</q-item-label>
                                                  </q-item-section>

                                                  <!-- <q-item-section side top>
                                                      <q-item-label caption>
                                                          <q-icon name="star" size="20px" color="yellow-8" style="margin-top: -4px"/>
                                                          <span class="text-subtitle2" style="padding-left: 5px">5,0</span>
                                                      </q-item-label>
                                                  </q-item-section> -->
                                              </q-item>
                                              <q-separator />
                                  ...
                                  <div class="row full-width" style="padding-top: 20px" v-else>
                                      <!-- <div class="row full-width justify-center">
                                          <q-icon name="mdi-emoticon-cry-outline" size="50px" color="primary" />
                                      </div> -->
                                      <div class="row full-width justify-center">
                                          <span class="text-subtitle1 text-primary text-weight-medium">Nenhum prestador se candidatou ainda</span>
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="row items-end" style="padding-bottom: 5px">
                                  <!-- <div class="col-2">
                                      <q-icon name="mdi-format-list-bulleted" color="primary" size="28px" />
                                  </div> -->
                                  <div class="col-12">
                              ...
                              <div class="row bg-grey-2" style="padding: 10px; border-radius: 8px; border-color: #dedede; border-style: solid; border-width:1px">
                                  <div class="row">
                                  ...
                                  <div class="row" v-if="servico.detalhes1.descricao !== undefined">
                                      ...
                                      <div class="row full-width" style="padding-left: 20px; margin-top: -5px; padding-bottom: 5px; text-align: justify;">
                                  ...
                                  <div class="row" v-if="servico.descricao !== undefined && servico.descricao !== null && servico.descricao !== ''">
                                      <span class="text-subtitle1 text-weight-medium">
                                          <q-icon name="mdi-chevron-right" color="primary" />
                              ...
                              <div v-if="isContratante === false">
                                  <div class="row items-end" style="padding-top: 25px; padding-bottom: 5px">
                                      <!-- <div class="col-2">
                                          <q-icon name="mdi-account" color="primary" size="28px" />
                                      </div> -->
                                      <div class="col-12">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="row full-width" style="margin-top: -5px;">
                                              <template v-for="(telefone, index) in servico.telefonesContratante" :key="index">
                                                  <div class="row full-width" style="padding-left: 25px; margin-top: 10px" @click="conversar(telefone)">
                                                      <div class="col-11">
                                                          <span class="text-body1">
                                                              {{telefone.numero}}
                                                          </span>
      ...
      <q-dialog v-model="isDescandidatar" persistent>
          <q-card style="width: 90vw">
              ...
              <q-card-section class="row items-center">
                  <span class="text-subtitle1" style="padding-left: 15px">Você realmente deseja não fazer mais parte da cotação desse serviço?</span>
              </q-card-section>
