        ...
        <q-tab-panels v-model="tab" animated>
          <q-tab-panel name="disponiveis" style="padding: 0px; width: 94vw;">
            <template v-for="servico in servicosDisponiveis" :key="servico._id">
              <q-card class="full-width" style="margin-bottom: 10px;" flat bordered @click="abrirServico(servico._id, servico.nomeCategoria, servico.nomeSubCategoria, servico.icone, servico.dataCadastro, 'D')">
                <q-card-section horizontal>
                  ...
                  <q-card-section class="row full-width" style="border-left-color: #999">
                    ...
                    <div class="col-12" style="margin-top: -5px;">
                      <span class="text-grey-7" style="font-size: 14px" v-if="servico.candidatos.length === 0">Nenhum prestador se candidatou ainda</span>
                      <span class="text-grey-7" style="font-size: 14px" v-else-if="servico.candidatos.length === 1">1 prestador se candidatou</span>
                      <span class="text-grey-7" style="font-size: 14px" v-else>{{servico.candidatos.length}} prestadores se candidataram</span>
                    </div>
                  </q-card-section>
                </q-card-section>
              </q-card>
          ...
          <q-tab-panel name="candidatados" style="padding: 0px; width: 94vw;">
            <template v-for="servico in servicosCandidatados" :key="servico._id">
              <q-card class="full-width" style="margin-bottom: 10px;" flat bordered @click="abrirServico(servico._id, servico.nomeCategoria, servico.nomeSubCategoria, servico.icone, servico.dataCadastro, 'C')">
                <q-card-section horizontal>
                  <q-icon class="col-2" :name="servico.icone" color="primary" size="36px" style="padding-left: 15px"/>
          ...
          <q-tab-panel name="solicitados" style="padding: 0px; width: 94vw;">
            <template v-for="servico in servicosSolicitados" :key="servico._id">
              <q-card class="full-width" style="margin-bottom: 10px;" flat bordered @click="abrirServico(servico._id, servico.nomeCategoria, servico.nomeSubCategoria, servico.icone, servico.dataCadastro, 'S')">
                <q-card-section horizontal>
                  <q-icon class="col-2" :name="servico.icone" color="primary" size="36px" style="padding-left: 15px"/>
