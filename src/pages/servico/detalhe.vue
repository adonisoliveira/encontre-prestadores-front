<template>
  <q-layout>
    <q-page-container>
      <q-footer>
        <q-btn :label="labelBtn" flat text-color="white" class="full-width bg-primary" size="22px" no-caps
          ...
          <div style="width: 800px; max-width: 100vw;">
            <q-card class="no-shadow">
              <div class="row q-gutter-sm bg-primary text-white"
                style="padding-left: 12px; padding-right: 10px; padding-top: 9px; padding-bottom: 9px;">
                <div class="col-1">
              ...
              <div class="row" v-else>
                <q-card elevation class="bg-white full-width no-shadow" Style="border-radius: 3px; padding: 0px;">
                  <q-card-section style="padding-top: 15px">
                    <div>
                      <span class="text-subtitle1 text-weight-regular">Existe mais alguma informação que o profissional
                        deva
                        saber?</span>
                    </div>
                    <q-input v-model="descricao" type="textarea" ref="descricao"
                      placeholder="Informe os dados extras aqui." autogrow :input-style="{ fontSize: '16px' }"
                      outlined />

                    <q-toggle v-model="orcamento" label="Quero somente um orçamento" checked-icon="mdi-check"
                      color="primary" icon-color="white" size="xl" left-label />
                    ...
                    <div class="row" style="padding: 10px;">
                      ...
                      <div class="row full-width" style="padding-bottom: 10px; text-align: justify;">
                        <span class="text-body2">Ao confirmar seu pedido os prestadores serão notificados e até três
                          prestadores
                          poderão entrar em contato com você. Você pode acompanhar seus pedidos na página
                          inicial.</span>
                      </div>
                    </div>
