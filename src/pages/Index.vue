    ...
    <q-page-container>
      <q-page>
        ...
        <div class="row justify-center text-center"
          style="padding-top: 150px; display: flex; flex-direction: column; align-items: center">
        ...
        <q-footer class="bg-white">
          <div class="row q-pa-md q-ma-none q-gutter-sm">
            <q-btn label="Criar uma conta" class="full-width text-blue-9 bg-white" outline no-caps size="20px"
              @click="cadastrar" />

            <q-btn label="Entrar sem cadastro" class="full-width text-blue-9 bg-white" outline no-caps size="20px"
              @click="entrarSemCadastro" />

            <q-btn label="Já tenho cadastro" class="full-width bg-primary text-white" flat no-caps size="20px"
              @click="entrar" />
          </div>
        </q-footer>
      </q-page>
