<template>
  <q-layout view="lHh Lpr lFf">
    <q-page-container>
      <!-- <q-page style="opacity: 1; background-image: url('statics/fundo1.png');"> -->
      <q-page>
        <q-btn
          icon="mdi-arrow-left"
          dense
        ...
        <div class="row justify-center text-center" style="padding-top: 100px; display: flex; flex-direction: column; align-items: center">
        ...
        <!-- <q-btn
          ...
          style="margin-top: 0px; padding-top: 10px; padding-left: 15px"
        />
        <div class="row justify-center text-center" style=" height: 95vh; display: flex; flex-direction: column; align-items: center">
          <div style="width: 800px; max-width: 90vw;">
            ...
            <div class="row justify-center text-center" style="margin-top: 10px">
              <span class="text-primary text-overline text-weight-medium" style=" font-size: 32px !important;">Encontre</span>
            </div>
            <div class="row justify-center text-center" style="margin-top: -5px">
              <span class="text-primary text-overline text-weight-medium" style="margin-bottom: -10px; font-size: 20px !important">Prestadores</span>
            </div>

            <div style="justify-content: end; margin-top: 200px;">
